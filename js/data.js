var PORTFOLIO_DATA = {
  ...
  projects: [{
    ...
    description: 'Powerful 3D game engine written in C++17, rendering on Vulkan. Includes 4 global illumination techniques, ray tracing support, screen space reflections, PBR, temporal AA, HBAO, Compute-based occlusion culling, and more. Check out the Github page for a larger list of features.',
